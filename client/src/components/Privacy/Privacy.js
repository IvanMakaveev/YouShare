const Privacy = () => {
    return (
        <div className="offset-md-2 col-md-8 my-3 text-left">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to YouShare.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to YouShare, accessible from <a href="https://youshare.web.app/" rel="external nofollow noopener" target="_blank">https://youshare.web.app/</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: ivan_em_makaveev@abv.bg</li>
            </ul>
        </div>
    );
}
